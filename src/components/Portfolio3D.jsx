          ...
          <div className="flex justify-center">
            <div className="w-80 h-80 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
              <div className="w-72 h-72 bg-black rounded-full flex items-center justify-center">
                <img src={IMGme} className="text-6xl rounded-full" alt="👨‍💻" />
      ...
      <div className="max-w-4xl mx-auto px-6 text-white text-center">
          ...
          <div className="bg-white/10 p-8 rounded-xl backdrop-blur-sm">
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-center">
                ...
                <span>samueldube123@gmail.com</span>
              </div>
              <div className="flex items-center">
                <span className="w-6 h-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mr-4"></span>
                <span>+263 78 807 7462</span>
              </div>
              <div className="flex items-center">
                <span className="w-6 h-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mr-4"></span>
                <span>linkedin.com/in/msamueldube</span>
              </div>
              <div className="flex items-center">
                <span className="w-6 h-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mr-4"></span>
                <span>github.com/MnqobiSD2018</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={MyCV} download>
                <button onClick={onButtonClick} className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-white font-semibold hover:scale-105 transition-transform">
                    Download Resume
                </button>
            </a>
